...
chrome.storage.sync.get(['player_info'], (data) => {
    document.getElementById("player_age").innerHTML = data.player_info.age;
    document.getElementById("player_foot").innerHTML = data.player_info.foot;
    document.getElementById("player_nation").innerHTML = data.player_info.nationality;
    document.getElementById("player_name").innerHTML = data.player_info.name;
    document.getElementById("player_img").src = data.player_info.profile_img;
    document.getElementById("player_pos").innerHTML = data.player_info.position;
